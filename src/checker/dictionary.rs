...
impl Dictionary {
    ...
    pub fn words_with_prefix(&self, prefix: &str) -> Vec<String> {
        ...
        let mut stream = self.set.search(fst::automaton::Str::new(prefix).starts_with()).into_stream();
        ...
        match language {
            "en_US" | "en_GB" | _ => {
                ...
                vec![
                    ...
                    "array", "list", "dictionary", "object", "parameter", "return", "import",
                    "export", "async", "await", "promise", "callback", "error", "exception",
                    "test", "debug", "compile", "build", "deploy", "version", "configuration",
                ]
                .iter()
                .map(|s| s.to_string())
                .collect()
